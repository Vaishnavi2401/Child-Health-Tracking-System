      ...
      <div>
       ...
       component="form"
        ...
        '& > :not(style)': { m: 1, width: '25ch' },
          ...
          autoComplete="off"
          >
        <button className="screening-btn-primary ">Basic Information</button>
        <button className="screening-btn-primary ">Family Information</button>
        <button className="screening-btn-primary ">BMI & Symptoms</button>
        <button className="screening-btn-primary ">Basic Screening</button>
        <button className="screening-btn-primary ">Immunisation</button>
        <button className="screening-btn-primary ">Dental Check Up</button>
        <button className="screening-btn-primary ">Vision</button>
        <button className="screening-btn-primary ">Psychological</button>
